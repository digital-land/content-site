module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addFilter(
    "totalFromRows",
    require("./lib/filters/total-from-rows")
  );
  ...
  eleventyConfig.addNunjucksShortcode(
    "govuk",
    require("./lib/shortcodes/govuk-component")
  );
  ...
  eleventyConfig.addCollection("guidance", (collection) => {
    return [
      ...collection
        .getFilteredByGlob("./app/content/guidance/*.md")
  ...
  eleventyConfig.addCollection("projects", (collection) => {
    return [
      ...collection
        .getFilteredByGlob("./app/content/project/*.md")
        .filter(function (item) {
          // will only return items that are not specifically hidden
          return item.data.hidden === false;
        }),
